...
public class ComienzaPago extends ServletRaiz {
    ...
    /** 
     * Par&aacute;metro que indica el concepto del pago
     */
    public final static String PARAM_CONCEPTO = "concepto";
    ...
    */
	...
	if (esBlancoONulo(pago.getConcepto())) {
            errorLog("[WARNING] Incorrecto Concepto:" + pago.getConcepto());
            return false;
        }
    ...
    */
    private PagoBean creaPago(HttpServletRequest request) {
        ...
        pago.setConcepto(request.getParameter(PARAM_CONCEPTO));
        double impd=-1.0;
        try {
